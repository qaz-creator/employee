...
class StateController extends Controller
{
    ...
    public function update(StateStoreRequest $request, State $state)
    {
        ...
        return redirect()->route('states.index')->with('message','Updated the state successfully');
    }
    ...
    {
        $state->delete();
        return redirect()->route('states.index')->with('message','Removed the state successfully');
